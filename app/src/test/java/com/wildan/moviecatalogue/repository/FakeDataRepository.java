...
import com.wildan.moviecatalogue.data.source.CatalogueDataSource;
...
class FakeDataRepository implements CatalogueDataSource {

    private final RemoteRepository remoteRepository;
    private final LocalRepository localRepository;
    private final AppExecutors appExecutors;

    FakeDataRepository(@NonNull LocalRepository localRepository,
